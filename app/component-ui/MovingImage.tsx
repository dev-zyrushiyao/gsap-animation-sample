  ...
  useGSAP(
    () => {
      gsap
        ...
        //shadow init
        .set("#shadow", { scaleX: 0 })
        // .set("#herman-wrapper", { y: 0, scaleX: 1, scaleY: 1 })
        ...
        // hole disappears
        .to("#hole", { scale: 0, duration: 0.7, ease: "power1.out" }, "<")
        // set shadow and expand a bit when herman is about to land
        .set("#shadow", { scaleX: 0.2 }, "<")
        .to("#shadow", { scaleX: 0.6, duration: 0.6, ease: "linear" }, "-=0.7")
        //   herman squashes
        .to(
          "#herman-wrapper",
          {
        ...
        .to("#shadow", { scaleX: 1, duration: 1.3, ease: "back(1.7)" }, "<")
        .to(
          "#herman-wrapper",
          { scale: 1, duration: 1, ease: "back(1.7)" },
          //   "-=0.3",
        )
        // shadow shrinks
        .to("#shadow", { scaleX: 0.7, duration: 0.7, ease: "power1" }, "<");
    ...
    <div ref={container}>
      <div id="video-container" className="flex flex-col items-center">
        ...
        >
          <div
            id="hole"
            className="absolute top-95 left-1/2 -translate-1/2 border-2 border-black rounded-[50%] h-5 w-60 bg-black  "
          ></div>
