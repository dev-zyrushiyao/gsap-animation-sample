...
gsap.registerPlugin(useGSAP, GSDevTools, DrawSVGPlugin, ScrollTrigger);
...
export default function FlowerSVG() {
  ...
  useGSAP(
    () => {
      ...
      const stem = document.querySelectorAll(".leaf-stem > *");
      const face = document.querySelector(".face");
      const eyes = document.querySelectorAll(".eyes");
      const innerPetal = document.querySelector(".inner-petal");
      const outerPetal = document.querySelector(".outer-petal");
      ...
      const leafTl = gsap
        ...
        .from(leafR, { transformOrigin: "left bottom" }, "<+=0.5");
      ...
      //Do not add a tween on a timeline if you are going to use a timeScale
      const flowerTl = gsap.timeline({ id: "flower-master-timeline" });
      // .timeScale(1.8);
